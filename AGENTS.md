...
**`AGENTS.md` is canonical; `CLAUDE.md` is a one-line import of it.** The format
leads roughly 2.85:1 on GitHub code search, and a single source avoids the two
files drifting apart. Edit `AGENTS.md`.
