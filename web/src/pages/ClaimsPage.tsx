  ...
  return [
    {
      ...
      renderCell: (claim) => (
        ...
        // the click itself is intercepted for in-app (SPA) navigation. Link's
        // own display is inline-flex (sized to content), which never shrinks
        // to the column width, so maxLines truncation had nothing to clip
        // against; isStandalone plus a block display makes it a real cell
        // citizen the way a bare Text column already is.
        <Link
